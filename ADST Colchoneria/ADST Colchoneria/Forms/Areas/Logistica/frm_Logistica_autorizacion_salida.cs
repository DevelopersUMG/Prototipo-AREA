...
namespace ADST_Colchoneria.Forms.Areas.Logistica
{
    public partial class frm_Logistica_autorizacion_salida : Form
    {
        ...
        public void salir()
        {
            ...
            gCon.actualizar(stTabla1, diDict2, stCondicion);            
        }
        ...
        public void creardetalle()
        {
            ...
            try
            {
                ...
                string stQuery = "SELECT tbm_factura_id_factura AS Factura, idtbm_vehiculo_cod_vehiculo AS Vehiculo FROM  `tbt_detalle_viajes` WHERE idtbm_viajes_logistica =" + stId_viaje + " order by idtbm_vehiculo_cod_vehiculo";
